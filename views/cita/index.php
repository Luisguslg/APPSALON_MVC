...
<p class="descripcion-pagina">Elige tus servicios y datos a continuación</p>
...
<div id="app">
    ...
    <div id="paso-1" class="seccion ocultar">
        <h2>Servicios</h2>
    ...
    <div id="paso-2" class="seccion ocultar">
        ...
        <p class="text-center">Elige tus datos y fecha de cita</p>
